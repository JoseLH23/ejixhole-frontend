...
const CalendarioOperativoPage = React.lazy(() => import("@/features/calendario/CalendarioOperativoPage").then((m) => ({ default: m.CalendarioOperativoPage })));
const TarifasEspecialesPage = React.lazy(() => import("@/features/tarifas/TarifasEspecialesPage").then((m) => ({ default: m.TarifasEspecialesPage })));
const ClientesListPage = React.lazy(() => import("@/features/clientes/ClientesListPage").then((m) => ({ default: m.ClientesListPage })));
const ServiciosListPage = React.lazy(() => import("@/features/servicios/ServiciosListPage").then((m) => ({ default: m.ServiciosListPage })));
...
const OcupacionReportPage = React.lazy(() => import("@/features/reportes/OcupacionReportPage").then((m) => ({ default: m.OcupacionReportPage })));
const ServiciosMasVendidosReportPage = React.lazy(() => import("@/features/reportes/ServiciosMasVendidosReportPage").then((m) => ({ default: m.ServiciosMasVendidosReportPage })));
const ClientesFrecuentesReportPage = React.lazy(() => import("@/features/reportes/ClientesFrecuentesReportPage").then((m) => ({ default: m.ClientesFrecuentesReportPage })));
const ReservacionesPorEstadoReportPage = React.lazy(() => import("@/features/reportes/ReservacionesPorEstadoReportPage").then((m) => ({ default: m.ReservacionesPorEstadoReportPage })));
const CancelacionesReportPage = React.lazy(() => import("@/features/reportes/CancelacionesReportPage").then((m) => ({ default: m.CancelacionesReportPage })));
const TendenciaReservacionesReportPage = React.lazy(() => import("@/features/reportes/TendenciaReservacionesReportPage").then((m) => ({ default: m.TendenciaReservacionesReportPage })));
const ClientesNuevosReportPage = React.lazy(() => import("@/features/reportes/ClientesNuevosReportPage").then((m) => ({ default: m.ClientesNuevosReportPage })));
